...
function ButtonBar(params: any) {
    ...
    return (
        ...
        <div className="d-flex flex-row justify-content-between border border-2 border-dark">
            <div className="">
                <div className="padding-btn-0_1 w-55px d-flex  justify-content-center  fs-custom-0_7">
            ...
            <div className="d-flex  justify-content-center  fs-custom-0_7">
                <div className="padding-btn-0_1">
                    ...
                    <button className={`rounded-pill btn btn-${BUTTON_COLOR__L_L} padding-btn-0 text-light  fs-custom-0_7`} type="button"
                    onClick={()=>{
